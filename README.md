...
> [鍵盤按鍵綁定一覽表](https://samwhelp.github.io/note-about-mabox-openbox/read/cheatsheet/keybind.html)
...
| 字型設定 | 微調腳本 |
| -------- | -------- |
| [設定字型查找順序](https://samwhelp.github.io/note-about-mabox/read/subject/font/config/font-match-order.html) | [微調腳本](https://github.com/samwhelp/mabox-adjustment/tree/main/prototype/main/font-config/font-match-order) |
...
| 中文輸入法 | 微調腳本 |
| ---------- | -------- |
| [新酷音輸入法](https://samwhelp.github.io/note-about-mabox/read/subject/input-method/fcitx5/module/fcitx5-chewing.html) | [微調腳本](https://github.com/samwhelp/mabox-adjustment/tree/main/prototype/main/im-config/fcitx5/fcitx5-chewing) |
...
| 佈景主題 |
| -------- |
| [設定採用「GURB 佈景主題」](https://samwhelp.github.io/note-about-mabox/read/subject/grub.html) |
